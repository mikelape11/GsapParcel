...
class Transformation {
  constructor({
    ...
    this.invalidations = new Map(); // TODO: these options may not impact all transformations, let transformers decide if they care or not
  ...
  async loadPipeline(filePath, isSource, request) {
    let configRequest = {
      filePath,
      env: this.request.env,
      isSource,
      pipeline: request === null || request === void 0 ? void 0 : request.pipeline,
      isURL: request === null || request === void 0 ? void 0 : request.isURL,
      meta: {
    ...
    let transformers = await this.parcelConfig.getTransformers(filePath, request === null || request === void 0 ? void 0 : request.pipeline, request === null || request === void 0 ? void 0 : request.isURL);
  ...
  async loadNextPipeline({
    ...
    let nextPipeline = await this.loadPipeline(nextFilePath, isSource, this.request);
